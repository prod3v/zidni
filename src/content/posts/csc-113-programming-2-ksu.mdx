---
title: "شرح مادة CSC 113 برمجة حاسبات 2 OOP - جامعة الملك سعود"
meta_title: "شرح CSC 113 برمجة 2 OOP جافا جامعة الملك سعود"
description: "شرح مادة CSC 113 برمجة 2 بجامعة الملك سعود: الكلاسات، الوراثة، تعدد الاشكال، الواجهات، معالجة الاستثناءات، والملفات بلغة جافا مع امثلة عملية."
date: 2026-03-18T09:00:00Z
image: "/images/posts/code-review-amico.svg"
categories: ["دليل المواد"]
authors: ["فريق زدني"]
tags: ["CSC 113", "عال 113", "جافا", "Java", "OOP", "جامعة الملك سعود"]
draft: false
---
...
مادة CSC 113، برمجة حاسبات 2 (Computer Programming 2)، هي المادة اللي تنقلك من كتابة كود يشتغل الى تصميم برامج منظمة وقابلة للتطوير. في خطة قسم علوم الحاسب بجامعة الملك سعود، هذي المادة تبني على كل شيء تعلمته في [CSC 111 برمجة حاسبات 1](/blog/csc-111-programming-1-ksu) وتعلمك البرمجة كائنية التوجه (Object-Oriented Programming) بلغة جافا. بدون مبالغة، اغلب المواد اللي بعدها تفترض انك متقن لمفاهيم OOP، من تراكيب البيانات الى هندسة البرمجيات وتطوير التطبيقات.
...
<QuickSummary>
- **رمز المادة:** CSC 113 (عال 113): برمجة حاسبات 2 (Computer Programming 2 / OOP)
- **الساعات المعتمدة:** 3 ساعات نظري + 1 عملي
- **المتطلب السابق:** [CSC 111 برمجة حاسبات 1](/blog/csc-111-programming-1-ksu)
...
- **يقود الى:** CSC 212 تراكيب البيانات (Data Structures)
</QuickSummary>

## ليش مادة CSC 113 مفصلية في مسارك؟
...
<Callout type="info" title="تحتاج تراجع CSC 111 قبل ما تبدا؟">
لو حاسس ان المتغيرات والحلقات والدوال والمصفوفات مو واضحة عندك 100%، ارجع راجعها قبل ما تبدا CSC 113. المادة تفترض انك متقن لكل شيء في [CSC 111](/blog/csc-111-programming-1-ksu). المراجعة السريعة الحين توفر عليك ساعات من المعاناة لاحقا.
</Callout>

## نظرة عامة على محتوى CSC 113
...
## 2. التغليف في CSC 113، Encapsulation
...
<CTABox title="واجب الوراثة محيّرك؟" description="الوراثة من اكثر المواضيع اللي يطلب فيها طلاب CSC 113 مساعدة. ارسل لنا السؤال على واتساب ونشرحه لك خطوة بخطوة مع الحل الكامل." buttonText="ارسل واجبك على واتساب" buttonUrl="https://wa.me/201557703662?text=مرحبا، احتاج مساعدة في واجب الوراثة - CSC 113 جامعة الملك سعود" />
...
نفس اسم الدالة بس باراميترات مختلفة. هذا تعلمته في CSC 111:
...
<CTABox title="مشروعك يحتاج ملفات و Exception Handling؟" description="كثير من مشاريع CSC 113 تطلب قراءة وكتابة ملفات مع معالجة اخطاء. ارسل لنا متطلبات المشروع ونساعدك تصممه وتنفذه بشكل احترافي." buttonText="ارسل متطلبات مشروعك" buttonUrl="https://wa.me/201557703662?text=مرحبا، احتاج مساعدة في مشروع CSC 113 - ملفات ومعالجة استثناءات - جامعة الملك سعود" />

## 8. اساسيات Collections: ArrayList

في CSC 111 تعلمت المصفوفات العادية (`int[]`). مشكلتها ان حجمها **ثابت** ما يتغير بعد الانشاء. `ArrayList` تحل هالمشكلة، تقدر تضيف وتحذف عناصر وهي تكبر وتصغر تلقائيا.
...
## انواع اسئلة الاختبارات في CSC 113
...
مشروع CSC 113 عادة يطلب منك تبني نظام متكامل يطبّق كل مفاهيم OOP اللي درستها. هذي خطوات تساعدك تنجح فيه:

<StepList title="خطوات النجاح في مشروع CSC 113">
...
اللاب في CSC 113 جزء اساسي من درجتك ويبني مهاراتك العملية. هذي نصائح تفرق معك:
...
## استراتيجية المذاكرة لـ CSC 113
...
## ربط CSC 113 بمسارك الاكاديمي

بعد ما تنهي CSC 113 بنجاح، المادة التالية في مسار البرمجة هي **CSC 212 تراكيب البيانات (Data Structures)**. في CSC 212 راح تستخدم كل مفاهيم OOP اللي تعلمتها هنا لبناء هياكل بيانات مثل القوائم المتصلة (Linked Lists) والاشجار (Trees) والمكدسات (Stacks) وطوابير الانتظار (Queues).

كل هالهياكل مبنية على كلاسات ووراثة وواجهات. لو اساسك في CSC 113 قوي، CSC 212 تصير اسهل بكثير. ولو اساسك ضعيف، راح تعاني لانك تحاول تفهم OOP وتراكيب البيانات في نفس الوقت.

لو تبي تقرا عن مادة تراكيب البيانات من الحين، راجع [شرح CSC 212 تراكيب البيانات](/blog/csc-212-data-structures-ksu). ولو تبي شرح اعمق لاساسيات جافا، اقرا [دليلنا الشامل لتعلم جافا](/blog/java-beginners-guide).

## خلاصة

مادة CSC 113 تغيّر طريقة تفكيرك في البرمجة بالكامل. بدل ما تكتب كود "يمشي الحال" كله في main واحد، تتعلم تصمم برامج منظمة وقابلة للتطوير والصيانة. المفاهيم الاساسية اللي لازم تتقنها:
...
لو فهمت هذي المفاهيم وتمرنت عليها كويس، CSC 113 ما راح تكون عقبة. بالعكس، راح تكون المادة اللي تفتح لك ابواب كل المواد المتقدمة في قسم علوم الحاسب بجامعة الملك سعود.

<CTABox title="واجب CSC 113 ضاغطك والديدلاين قريب؟" description="فريقنا متخصص في مواد قسم علوم الحاسب بجامعة الملك سعود. ارسل لنا الواجب او المشروع على واتساب ونرد عليك بعرض سعر خلال ساعة، شرح وحل كامل." buttonText="ارسل واجبك الان" buttonUrl="https://wa.me/201557703662?text=مرحبا، احتاج مساعدة في واجب CSC 113 برمجة حاسبات 2 - جامعة الملك سعود" />
