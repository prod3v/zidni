...
HTML و CSS ليستا لغتي برمجة — لا تحتوي على متغيرات أو حلقات أو شروط مثل [Java](/blog/java-beginners-guide) أو Python. هما لغتا **وصف وتنسيق**. لكنهما الأساس الذي تُبنى عليه كل مواقع الإنترنت بدون استثناء، وتعلّمهما ضروري قبل الانتقال إلى أي لغة برمجة ويب مثل JavaScript.
</Callout>
...
ثم نضيف صفوف البيانات داخل `<tbody>` — كل صف يمثّل لغة ومعلوماتها:
