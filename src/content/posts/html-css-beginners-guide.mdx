...
description: "دليل شامل لتعلم HTML و CSS من الصفر للمبتدئين: بنية صفحات الويب، العناصر الأساسية، التنسيق والألوان، التصميم المتجاوب، ومشروع عملي لبناء أول صفحة ويب بيدك."
date: 2025-12-15T09:00:00Z
image: "/images/posts/code-typing.svg"
categories: ["دليل المواد"]
authors: ["فريق زدني"]
tags: ["HTML", "CSS", "Web Development", "برمجة"]
draft: false
---
...
HTML و CSS ليستا لغتي برمجة، فهي لا تحتوي على متغيرات أو حلقات أو شروط مثل [Java](/blog/java-beginners-guide) أو Python. هما لغتا **وصف وتنسيق**. لكنهما الأساس الذي تُبنى عليه كل مواقع الإنترنت بدون استثناء، وتعلّمهما ضروري قبل الانتقال إلى أي لغة برمجة ويب مثل JavaScript.
</Callout>
...
<CTABox
  title="تحتاج شرح خصوصي في تطوير الويب؟"
  description="نشرح لك مفاهيم HTML و CSS و JavaScript بأسلوب مبسّط ونساعدك تبني مشاريع عملية تعزز فهمك"
  buttonText="احجز جلسة شرح"
  buttonUrl="https://wa.me/201557703662?text=مرحبا، أحتاج شرح خصوصي في تطوير الويب"
/>
...
<CTABox
  ...
  buttonUrl="https://wa.me/201557703662?text=مرحبا، أحتاج مساعدة في واجب HTML و CSS"
/>
...
للاطلاع على قائمة شاملة بمنصات ودورات مجانية لتعلم البرمجة، راجع مقالنا عن [أفضل مصادر تعلم البرمجة المجانية](/blog/free-programming-learning-resources).
...
<CTABox
  title="تحتاج مساعدة في HTML أو CSS؟"
  description="نشرح لك المفاهيم ونراجع كودك، تتعلم وتنجز واجبك بثقة"
  buttonText="تواصل معنا"
  buttonUrl="https://wa.me/201557703662?text=مرحبا، أحتاج مساعدة في واجب HTML و CSS"
/>
