...
description: "شرح مادة CPIT 405 تطبيقات الإنترنت بجامعة الملك عبدالعزيز: HTML5، CSS3، JavaScript، PHP، MySQL، REST APIs، وأمان الويب. دليل عملي بأمثلة كود وخطة مذاكرة أسبوعية."
