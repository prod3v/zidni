...
description: "شرح شامل لمادة CPIT 405 تطبيقات الإنترنت بجامعة الملك عبدالعزيز: HTML5، CSS3، JavaScript، PHP، MySQL، REST APIs، وأمان الويب. دليل عملي بأمثلة كود وخطة مذاكرة أسبوعية."
date: 2026-03-25T09:00:00Z
image: "/images/posts/code-typing.svg"
categories: ["دليل المواد"]
authors: ["فريق زدني"]
tags: ["CPIT 405", "تطبيقات الإنترنت", "Web Development", "PHP", "جامعة الملك عبدالعزيز"]
draft: false
---
...
مادة CPIT 405 تطبيقات الإنترنت واحدة من أكثر المواد العملية في خطة IT بجامعة الملك عبدالعزيز. صعوبتها مش في عمق المفاهيم بل في **كثرة التقنيات** وحاجتك تربط بينها في مشروع متكامل.
