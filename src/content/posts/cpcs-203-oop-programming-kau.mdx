...
description: "شرح شامل لمادة CPCS 203 برمجة 2 بجامعة الملك عبدالعزيز: الكلاسات، الكائنات، التغليف، الوراثة، تعدد الأشكال، معالجة الاستثناءات، والتعامل مع الملفات بلغة جافا."
...
- **الكتاب المقرر:** "An Introduction to Object-Oriented Programming with Java"، C. Thomas Wu (McGraw-Hill)
...
المادة تستخدم كتاب C. Thomas Wu من McGraw-Hill، وهو كتاب مختلف عن كتاب Liang المستخدم في CPCS 202. تاكد تشتري الكتاب الصح من المكتبة أو تحصله من زملاء السنة اللي فاتت.
</Callout>
