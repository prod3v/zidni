...
| 15 | مراجعة + اختبار اللاب النهائي | حل برنامج كامل في اللاب |
...
<StepList title="كيف تحضّر للواجبات واختبار اللاب">
...
<Callout type="tip" title="للاختبار العملي النهائي">
...
<CTABox title="واجب CPCS 203 صعب عليك؟" description="فريقنا متخصص في واجبات OOP بجافا. أرسل لنا الواجب على واتساب ونرد عليك بعرض سعر خلال ساعة." buttonText="أرسل واجبك على واتساب" buttonUrl="https://wa.me/201557703662?text=مرحبا، أحتاج مساعدة في واجب CPCS 203" />
