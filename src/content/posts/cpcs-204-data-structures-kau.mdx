...
لو تبي تراجع أساسيات جافا، ارجع لـ [شرح مادة CPCS 202 برمجة 1](/blog/cpcs-202-programming-1-kau). ولو تبي تراجع مفاهيم OOP، اقرأ [شرح مادة CPCS 203 برمجة 2](/blog/cpcs-203-oop-programming-kau). ولمراجعة شاملة لهياكل البيانات، اقرأ [دليلنا الشامل لهياكل البيانات](/blog/data-structures-algorithms-guide).
